...
const Cart = () => {
  ...
  const fetchCartItems = async () => {
    ...
    setLoading(true);
    try {
      const id_login = JSON.parse(userLocal).id_login;

      const response = await axios.get('/cart/getById/' + id_login, {
        ...
        <div className="cart-items">
          {loading ? (
            ...
            <div className="empty-cart">
              ...
              <button onClick={() => navigate('/games')} className="continue-shopping">Ir al Catálogo</button>
            </div>
          ) : (
